...
- Confirme se as informações de usuário, senha, banco de dados, ip, porta e demais informações na URL do banco estão de acordo com o "docker-compose.yml"e configure a URL caso necessário.
